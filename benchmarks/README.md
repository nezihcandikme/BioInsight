...
scripts above; the summary markdown is the committed record. As with
every other benchmark in this project, the actual numbers get written up
as-run in `DEVLOG.md`, including if they turn out unflattering.
